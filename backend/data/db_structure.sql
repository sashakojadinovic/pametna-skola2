...
CREATE TABLE day_schedule (
  ...
  note TEXT, playlist_id INTEGER REFERENCES playlists(id),
...
, is_active INTEGER NOT NULL DEFAULT 1, is_default INTEGER NOT NULL DEFAULT 0, created_at TEXT DEFAULT (datetime('now')), updated_at TEXT DEFAULT (datetime('now')));
CREATE TABLE tracks (
  id INTEGER PRIMARY KEY AUTOINCREMENT,
